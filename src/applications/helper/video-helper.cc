...
#include "ns3/video-application.h"

namespace ns3 {

VideoHelper::VideoHelper (std::string protocol, Address address)
{
  m_factory.SetTypeId ("ns3::VideoApplication");
...
// int64_t
// VideoHelper::AssignStreams (NodeContainer c, int64_t stream)
// {
...
// void 
// VideoHelper::SetConstantRate (DataRate dataRate, uint32_t packetSize)
// {
