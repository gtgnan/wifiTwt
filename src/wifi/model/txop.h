...
public:
   ...
   * \param hdr header of packet to send.
   *
   * Store the packet in the internal queue and Push it to the front until it
   * can be sent safely.
   */
  virtual void QueueFront (Ptr<Packet> packet, const WifiMacHeader &hdr);
  /**
