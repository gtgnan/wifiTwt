...
public:
  ...
  /**
   * Return true if the Type is WIFI_MAC_CTL_PSPOLL.
   *
   * \return true if the Type is WIFI_MAC_CTL_PSPOLL, false otherwise
   */
...
private:
  ...
  uint8_t m_ctrlPowerMgt; ///< control power management
