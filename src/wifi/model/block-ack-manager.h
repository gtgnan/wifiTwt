...
public:
   ...
   * \param tid the TID the acknowledged MPDUs belong to
   * 
   *
   * Used to forcefully move the block ack window
   * Used only for TWT RR multiuser scheduler
   * All Packets for this recipient and tid are made to be ACKed
   * Inactivity timer is not updated
   */
  void ForceAllNotifyGotBlockAck (Mac48Address recipient, uint8_t tid);
  /**
